...
int FaceMeshService::load(const char *modeltype) {
    ...
    faceseg.load_param("Pkg/ComputingServ/FaceMesh/models/faceseg-op.param");
    faceseg.load_model("Pkg/ComputingServ/FaceMesh/models/faceseg-op.bin");
    facept.load_param("Pkg/ComputingServ/FaceMesh/models/facemesh-op.param");
    facept.load_model("Pkg/ComputingServ/FaceMesh/models/facemesh-op.bin");
    ...
    char parampath[256];
    char modelpath[256];
    sprintf(parampath, "Pkg/ComputingServ/FaceMesh/models/scrfd_%s-opt2.param", modeltype);
    sprintf(modelpath, "Pkg/ComputingServ/FaceMesh/models/scrfd_%s-opt2.bin", modeltype);
