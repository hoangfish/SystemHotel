...
TMtCNN::TMtCNN(void) {
    ...
    Pnet.load_param("Pkg/ComputingServ/FaceCheck/models/mtcnn/det1.param");
    Pnet.load_model("Pkg/ComputingServ/FaceCheck/models/mtcnn/det1.bin");
    Rnet.opt.use_vulkan_compute = true;
    Rnet.load_param("Pkg/ComputingServ/FaceCheck/models/mtcnn/det2.param");
    Rnet.load_model("Pkg/ComputingServ/FaceCheck/models/mtcnn/det2.bin");
    Onet.opt.use_vulkan_compute = true;
    Onet.load_param("Pkg/ComputingServ/FaceCheck/models/mtcnn/det3.param");
    Onet.load_model("Pkg/ComputingServ/FaceCheck/models/mtcnn/det3.bin");
}
