...
void TLive::LoadModel(void) {
    ...
    for (int i = 0; i < model_num_; ++i) {
        ...
        std::string param = "Pkg/ComputingServ/FaceCheck/models/live/" + configs_[i].name + ".param";
        std::string model = "Pkg/ComputingServ/FaceCheck/models/live/" + configs_[i].name + ".bin";
